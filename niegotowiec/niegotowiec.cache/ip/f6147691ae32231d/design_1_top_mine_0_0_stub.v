...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(clk, clk_TMDS, hdmi_tx_p, hdmi_tx_n, 
  hdmi_tx_clk_p, hdmi_tx_clk_n)
/* synthesis syn_black_box black_box_pad_pin="clk,clk_TMDS,hdmi_tx_p[2:0],hdmi_tx_n[2:0],hdmi_tx_clk_p,hdmi_tx_clk_n" */;
  input clk;
  input clk_TMDS;
