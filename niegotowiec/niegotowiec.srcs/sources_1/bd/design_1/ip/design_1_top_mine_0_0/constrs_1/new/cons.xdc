...
create_clock -period 40.000 -name c -waveform {0.000 20.000} -add [get_ports clk]
create_clock -period 4.000 -name p -waveform {0.000 2.000} -add [get_ports clk_TMDS]
...
#set_property -dict { PACKAGE_PIN T15   IOSTANDARD LVCMOS25 } [get_ports { led_sda }]; #IO_L15N_T2_DQS_13 Sch=led[1]
#set_property -dict { PACKAGE_PIN T16   IOSTANDARD LVCMOS25 } [get_ports { led_scl }]; #IO_L17P_T2_13 Sch=led[2]
