...
set_property -dict { PACKAGE_PIN AB12  IOSTANDARD LVCMOS25 } [get_ports { hpa }]; #IO_L7N_T1_13 Sch=hdmi_rx_hpa
...
set_property -dict { PACKAGE_PIN R3    IOSTANDARD LVCMOS33 } [get_ports { txen }]; #IO_L3P_T0_DQS_34 Sch=hdmi_rx_txen
...
#set_property -dict { PACKAGE_PIN U3    IOSTANDARD LVCMOS33 } [get_ports { DDC_scl_o }]; #IO_L6P_T0_34 Sch=hdmi_tx_rscl
#set_property -dict { PACKAGE_PIN V3    IOSTANDARD LVCMOS33 } [get_ports { DDC_sda_o }]; #IO_L6N_T0_VREF_34 Sch=hdmi_tx_rsda
