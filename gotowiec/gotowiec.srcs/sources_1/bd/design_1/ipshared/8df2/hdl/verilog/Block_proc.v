...
parameter    ap_const_lv11_2D0 = 11'b1011010000;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((1'b1 == ap_continue)) begin
            ap_done_reg <= 1'b0;
        end else if (((ap_CS_fsm_state1 == 1'b1) & ~(ap_condition_43 == 1'b1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_done_reg) | ((ap_CS_fsm_state1 == 1'b1) & ~(ap_condition_43 == 1'b1)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((ap_CS_fsm_state1 == 1'b1) & ~(ap_condition_43 == 1'b1))) begin
        ap_ready = 1'b1;
    end else begin
        ap_ready = 1'b0;
    end
...
always @ (*) begin
    ap_condition_43 = ((img_0_rows_V_out_full_n == 1'b0) | (img_0_cols_V_out_full_n == 1'b0) | (ap_start == 1'b0) | (ap_done_reg == 1'b1));
end

assign img_0_cols_V_out_din = ap_const_lv12_500;

assign img_0_rows_V_out_din = ap_const_lv11_2D0;
