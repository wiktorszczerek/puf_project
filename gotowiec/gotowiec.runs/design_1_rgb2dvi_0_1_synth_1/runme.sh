...
HD_PWD='E:/STUDIA/PUF/gotowiec/gotowiec.runs/design_1_rgb2dvi_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_rgb2dvi_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_rgb2dvi_0_1.tcl
