...
HD_PWD='E:/STUDIA/PUF/hdmi1/hdmi1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_mine.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_mine.tcl -notrace
