...
HD_PWD='E:/STUDIA/PUF/hdmi1/hdmi1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_mine.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_mine.tcl
