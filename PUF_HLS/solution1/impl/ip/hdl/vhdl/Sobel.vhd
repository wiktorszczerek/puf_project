...
architecture behav of Sobel is 
    ...
    signal grp_Filter2D_fu_52_ap_start_reg : STD_LOGIC := '0';
...
begin
    ...
    grp_Filter2D_fu_52_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
    ...
    grp_Filter2D_fu_52_ap_start <= grp_Filter2D_fu_52_ap_start_reg;
    p_dst_data_stream_V_din <= grp_Filter2D_fu_52_p_dst_data_stream_V_din;
