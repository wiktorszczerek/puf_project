...
reg   [0:0] tmp_user_V_fu_126;
reg    ap_block_pp0_stage0_01001;
reg   [3:0] ap_NS_fsm;
reg    ap_idle_pp0;
wire    ap_enable_pp0;
wire   [23:0] OUTPUT_STREAM_TDATA_int;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((regslice_both_AXI_video_strm_V_data_V_U_apdone_blk == 1'b0) & (icmp_ln125_fu_204_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b1 == ap_condition_pp0_exit_iter0_state3) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
            ap_enable_reg_pp0_iter0 <= 1'b0;
        end else if (((regslice_both_AXI_video_strm_V_data_V_U_apdone_blk == 1'b0) & (icmp_ln125_fu_204_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln126_fu_216_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln126_reg_270 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        tmp_user_V_fu_126 <= 1'd0;
    end else if ((~((ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        tmp_user_V_fu_126 <= 1'd1;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln126_fu_216_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    if ((((icmp_ln126_reg_270_pp0_iter1_reg == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((icmp_ln126_reg_270 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
...
always @ (*) begin
    if ((icmp_ln126_fu_216_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((regslice_both_AXI_video_strm_V_data_V_U_apdone_blk == 1'b0) & (icmp_ln125_fu_204_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((icmp_ln126_reg_270 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((icmp_ln126_fu_216_p2 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone)) & ~((ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone)) | ((icmp_ln126_fu_216_p2 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone)))) begin
...
assign OUTPUT_STREAM_TDATA_int = {{{img_data_stream_2_V_dout}, {img_data_stream_1_V_dout}}, {img_data_stream_0_V_dout}};

assign OUTPUT_STREAM_TVALID = regslice_both_AXI_video_strm_V_data_V_U_vld_out;
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (((icmp_ln126_reg_270 == 1'd0) & (img_data_stream_2_V_empty_n == 1'b0)) | ((icmp_ln126_reg_270 == 1'd0) & (img_data_stream_1_V_empty_n == 1'b0)) | ((icmp_ln126_reg_270 == 1'd0) & (img_data_stream_0_V_empty_n == 1'b0))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((1'b1 == ap_block_state5_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state4_io) | ((icmp_ln126_reg_270 == 1'd0) & (img_data_stream_2_V_empty_n == 1'b0)) | ((icmp_ln126_reg_270 == 1'd0) & (img_data_stream_1_V_empty_n == 1'b0)) | ((icmp_ln126_reg_270 == 1'd0) & (img_data_stream_0_V_empty_n == 1'b0)))));
end
...
always @ (*) begin
    ap_block_state4_io = ((icmp_ln126_reg_270 == 1'd0) & (1'b0 == OUTPUT_STREAM_TREADY_int));
end

always @ (*) begin
    ap_block_state4_pp0_stage0_iter1 = (((icmp_ln126_reg_270 == 1'd0) & (img_data_stream_2_V_empty_n == 1'b0)) | ((icmp_ln126_reg_270 == 1'd0) & (img_data_stream_1_V_empty_n == 1'b0)) | ((icmp_ln126_reg_270 == 1'd0) & (img_data_stream_0_V_empty_n == 1'b0)));
end

always @ (*) begin
    ap_block_state5_io = ((icmp_ln126_reg_270_pp0_iter1_reg == 1'd0) & (1'b0 == OUTPUT_STREAM_TREADY_int));
end
...
assign icmp_ln125_fu_204_p2 = ((t_V_reg_177 == 10'd720) ? 1'b1 : 1'b0);

assign icmp_ln126_fu_216_p2 = ((t_V_1_reg_188 == 11'd1280) ? 1'b1 : 1'b0);
