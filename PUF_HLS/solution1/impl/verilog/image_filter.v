...
(* CORE_GENERATION_INFO="image_filter,hls_ip_2019_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7a200t-sbg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=11.000000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=9,HLS_SYN_DSP=35,HLS_SYN_FF=6013,HLS_SYN_LUT=10095,HLS_VERSION=2019_2}" *)
...
wire   [10:0] Block_proc_U0_img_5_rows_V_out_din;
wire    Block_proc_U0_img_5_rows_V_out_write;
wire   [11:0] Block_proc_U0_img_5_cols_V_out_din;
wire    Block_proc_U0_img_5_cols_V_out_write;
...
wire   [10:0] AddWeighted_U0_dst_rows_V_out_din;
...
wire    img_5_rows_V_c_full_n;
wire   [10:0] img_5_rows_V_c_dout;
wire    img_5_rows_V_c_empty_n;
wire    img_5_cols_V_c_full_n;
wire   [11:0] img_5_cols_V_c_dout;
wire    img_5_cols_V_c_empty_n;
...
wire   [10:0] img_0_rows_V_c22_dout;
wire    img_0_rows_V_c22_empty_n;
wire    img_0_cols_V_c23_full_n;
wire   [11:0] img_0_cols_V_c23_dout;
...
wire    img_5_rows_V_c24_full_n;
wire   [10:0] img_5_rows_V_c24_dout;
wire    img_5_rows_V_c24_empty_n;
wire    img_5_cols_V_c25_full_n;
wire   [11:0] img_5_cols_V_c25_dout;
wire    img_5_cols_V_c25_empty_n;
...
fifo_w11_d7_A img_5_rows_V_c_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w12_d7_A img_5_cols_V_c_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w11_d2_A img_0_rows_V_c22_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w12_d2_A img_0_cols_V_c23_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w11_d2_A img_5_rows_V_c24_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w12_d2_A img_5_cols_V_c25_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
start_for_AddWeigsc4 start_for_AddWeigsc4_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
start_for_Gaussiaudo start_for_Gaussiaudo_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
start_for_Duplicavdy start_for_Duplicavdy_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
