...
reg    grp_Filter2D_fu_52_ap_start_reg;
...
#0 ap_done_reg = 1'b0;
#0 ap_CS_fsm = 2'd1;
#0 grp_Filter2D_fu_52_ap_start_reg = 1'b0;
end
...
Filter2D grp_Filter2D_fu_52(
    ...
    .p_kernel_val_0_V_1_read(2'd2),
    .p_kernel_val_0_V_2_read(2'd3),
    .p_kernel_val_1_V_0_read(3'd0),
    .p_kernel_val_1_V_2_read(4'd0),
    .p_kernel_val_2_V_0_read(2'd1),
    .p_kernel_val_2_V_1_read(3'd2)
);
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_Filter2D_fu_52_ap_start_reg <= 1'b0;
    end else begin
        if ((~((ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
            grp_Filter2D_fu_52_ap_start_reg <= 1'b1;
...
assign grp_Filter2D_fu_52_ap_start = grp_Filter2D_fu_52_ap_start_reg;
