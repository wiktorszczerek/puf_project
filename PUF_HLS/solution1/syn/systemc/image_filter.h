...
#include "start_for_AddWeigsc4.h"
#include "start_for_CvtColotde.h"
#include "start_for_Gaussiaudo.h"
#include "start_for_Duplicavdy.h"
#include "start_for_Sobel_U0.h"
#include "start_for_Sobel_1wdI.h"
#include "start_for_CvtColoxdS.h"
...
struct image_filter : public sc_module {
    ...
    sc_signal< sc_lv<11> > Block_proc_U0_img_5_rows_V_out_din;
    sc_signal< sc_logic > Block_proc_U0_img_5_rows_V_out_write;
    sc_signal< sc_lv<12> > Block_proc_U0_img_5_cols_V_out_din;
    sc_signal< sc_logic > Block_proc_U0_img_5_cols_V_out_write;
    ...
    sc_signal< sc_lv<11> > AddWeighted_U0_dst_rows_V_out_din;
    ...
    sc_signal< sc_logic > img_5_rows_V_c_full_n;
    sc_signal< sc_lv<11> > img_5_rows_V_c_dout;
    sc_signal< sc_logic > img_5_rows_V_c_empty_n;
    sc_signal< sc_logic > img_5_cols_V_c_full_n;
    sc_signal< sc_lv<12> > img_5_cols_V_c_dout;
    sc_signal< sc_logic > img_5_cols_V_c_empty_n;
    ...
    sc_signal< sc_logic > img_0_rows_V_c22_full_n;
    sc_signal< sc_lv<11> > img_0_rows_V_c22_dout;
    sc_signal< sc_logic > img_0_rows_V_c22_empty_n;
    sc_signal< sc_logic > img_0_cols_V_c23_full_n;
    sc_signal< sc_lv<12> > img_0_cols_V_c23_dout;
    sc_signal< sc_logic > img_0_cols_V_c23_empty_n;
    ...
    sc_signal< sc_logic > img_5_rows_V_c24_full_n;
    sc_signal< sc_lv<11> > img_5_rows_V_c24_dout;
    sc_signal< sc_logic > img_5_rows_V_c24_empty_n;
    sc_signal< sc_logic > img_5_cols_V_c25_full_n;
    sc_signal< sc_lv<12> > img_5_cols_V_c25_dout;
    sc_signal< sc_logic > img_5_cols_V_c25_empty_n;
