...
Duplicate::Duplicate(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sensitive << ( icmp_ln1558_fu_152_p2 );

    SC_METHOD(thread_ap_done);
    sensitive << ( ap_done_reg );
    sensitive << ( icmp_ln1557_fu_140_p2 );
    ...
    SC_METHOD(thread_icmp_ln1557_fu_140_p2);
    sensitive << ( ap_CS_fsm_state2 );
    sensitive << ( t_V_reg_118 );

    SC_METHOD(thread_icmp_ln1558_fu_152_p2);
    sensitive << ( ap_CS_fsm_pp0_stage0 );
    ...
    sc_trace(mVcdFile, icmp_ln1558_reg_173, "icmp_ln1558_reg_173");
    ...
    sc_trace(mVcdFile, icmp_ln1557_fu_140_p2, "icmp_ln1557_fu_140_p2");
    sc_trace(mVcdFile, ap_CS_fsm_state2, "ap_CS_fsm_state2");
    sc_trace(mVcdFile, i_V_fu_146_p2, "i_V_fu_146_p2");
    sc_trace(mVcdFile, i_V_reg_168, "i_V_reg_168");
    sc_trace(mVcdFile, icmp_ln1558_fu_152_p2, "icmp_ln1558_fu_152_p2");
...
void Duplicate::thread_ap_clk_no_reset_() {
    ...
    if ( ap_rst.read() == ap_const_logic_1) {
        ...
        if (esl_seteq<1,1,1>(ap_const_logic_1, ap_continue.read())) {
            ap_done_reg = ap_const_logic_0;
                    ...
                    esl_seteq<1,1,1>(icmp_ln1557_fu_140_p2.read(), ap_const_lv1_1))) {
    ...
    if ( ap_rst.read() == ap_const_logic_1) {
        ...
        if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && 
            ...
            ap_enable_reg_pp0_iter0 = ap_const_logic_0;
                    ...
                    esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln1557_fu_140_p2.read()))) {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && 
         ...
         esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln1558_fu_152_p2.read()))) {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0))) {
        icmp_ln1558_reg_173 = icmp_ln1558_fu_152_p2.read();
    }
}
...
void Duplicate::thread_ap_block_pp0_stage0_01001() {
    ap_block_pp0_stage0_01001 = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && ((esl_seteq<1,1,1>(icmp_ln1558_reg_173.read(), ap_const_lv1_0) && 
   esl_seteq<1,1,1>(ap_const_logic_0, src_data_stream_V_empty_n.read())) || 
  (esl_seteq<1,1,1>(icmp_ln1558_reg_173.read(), ap_const_lv1_0) && 
...
void Duplicate::thread_ap_block_pp0_stage0_11001() {
    ap_block_pp0_stage0_11001 = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && ((esl_seteq<1,1,1>(icmp_ln1558_reg_173.read(), ap_const_lv1_0) && 
   esl_seteq<1,1,1>(ap_const_logic_0, src_data_stream_V_empty_n.read())) || 
  (esl_seteq<1,1,1>(icmp_ln1558_reg_173.read(), ap_const_lv1_0) && 
   esl_seteq<1,1,1>(ap_const_logic_0, dst1_data_stream_V_full_n.read())) || 
  (esl_seteq<1,1,1>(icmp_ln1558_reg_173.read(), ap_const_lv1_0) && 
...
void Duplicate::thread_ap_block_pp0_stage0_subdone() {
    ap_block_pp0_stage0_subdone = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && ((esl_seteq<1,1,1>(icmp_ln1558_reg_173.read(), ap_const_lv1_0) && 
   esl_seteq<1,1,1>(ap_const_logic_0, src_data_stream_V_empty_n.read())) || 
  (esl_seteq<1,1,1>(icmp_ln1558_reg_173.read(), ap_const_lv1_0) && 
   esl_seteq<1,1,1>(ap_const_logic_0, dst1_data_stream_V_full_n.read())) || 
  (esl_seteq<1,1,1>(icmp_ln1558_reg_173.read(), ap_const_lv1_0) && 
...
void Duplicate::thread_ap_block_state4_pp0_stage0_iter1() {
    ap_block_state4_pp0_stage0_iter1 = ((esl_seteq<1,1,1>(icmp_ln1558_reg_173.read(), ap_const_lv1_0) && 
  esl_seteq<1,1,1>(ap_const_logic_0, src_data_stream_V_empty_n.read())) || (esl_seteq<1,1,1>(icmp_ln1558_reg_173.read(), ap_const_lv1_0) && 
  esl_seteq<1,1,1>(ap_const_logic_0, dst1_data_stream_V_full_n.read())) || (esl_seteq<1,1,1>(icmp_ln1558_reg_173.read(), ap_const_lv1_0) && 
  esl_seteq<1,1,1>(ap_const_logic_0, dst2_data_stream_V_full_n.read())));
}

void Duplicate::thread_ap_condition_pp0_exit_iter0_state3() {
    if (esl_seteq<1,1,1>(icmp_ln1558_fu_152_p2.read(), ap_const_lv1_1)) {
...
void Duplicate::thread_icmp_ln1557_fu_140_p2() {
    icmp_ln1557_fu_140_p2 = (!t_V_reg_118.read().is_01() || !ap_const_lv10_2D0.is_01())? sc_lv<1>(): sc_lv<1>(t_V_reg_118.read() == ap_const_lv10_2D0);
}

void Duplicate::thread_icmp_ln1558_fu_152_p2() {
    icmp_ln1558_fu_152_p2 = (!t_V_3_reg_129.read().is_01() || !ap_const_lv11_500.is_01())? sc_lv<1>(): sc_lv<1>(t_V_3_reg_129.read() == ap_const_lv11_500);
}
...
void Duplicate::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        case 1 : 
            ...
            break;
        case 2 : 
            if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && esl_seteq<1,1,1>(icmp_ln1557_fu_140_p2.read(), ap_const_lv1_1))) {
                ap_NS_fsm = ap_ST_fsm_state1;
            } else {
            ...
            break;
        case 4 : 
            if (!(esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_subdone.read(), ap_const_boolean_0) && esl_seteq<1,1,1>(icmp_ln1558_fu_152_p2.read(), ap_const_lv1_1))) {
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_subdone.read(), ap_const_boolean_0) && esl_seteq<1,1,1>(icmp_ln1558_fu_152_p2.read(), ap_const_lv1_1))) {
