...
Block_proc::Block_proc(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sensitive << ( img_5_rows_V_out_full_n );
    sensitive << ( img_5_cols_V_out_full_n );
    ...
    SC_METHOD(thread_img_5_cols_V_out_blk_n);
    sensitive << ( real_start );
    sensitive << ( ap_done_reg );
    sensitive << ( ap_CS_fsm_state1 );
    sensitive << ( img_5_cols_V_out_full_n );

    SC_METHOD(thread_img_5_cols_V_out_din);
    sensitive << ( real_start );
    sensitive << ( ap_done_reg );
    sensitive << ( ap_CS_fsm_state1 );
    sensitive << ( img_0_rows_V_out_full_n );
    ...
    SC_METHOD(thread_img_5_cols_V_out_write);
    sensitive << ( real_start );
    sensitive << ( ap_done_reg );
    sensitive << ( ap_CS_fsm_state1 );
    sensitive << ( img_0_rows_V_out_full_n );
    ...
    SC_METHOD(thread_img_5_rows_V_out_blk_n);
    sensitive << ( real_start );
    sensitive << ( ap_done_reg );
    sensitive << ( ap_CS_fsm_state1 );
    sensitive << ( img_5_rows_V_out_full_n );

    SC_METHOD(thread_img_5_rows_V_out_din);
    sensitive << ( real_start );
    sensitive << ( ap_done_reg );
    sensitive << ( ap_CS_fsm_state1 );
    sensitive << ( img_0_rows_V_out_full_n );
    ...
    SC_METHOD(thread_img_5_rows_V_out_write);
    sensitive << ( real_start );
    sensitive << ( ap_done_reg );
    sensitive << ( ap_CS_fsm_state1 );
    sensitive << ( img_0_rows_V_out_full_n );
    ...
    sc_trace(mVcdFile, img_5_rows_V_out_din, "(port)img_5_rows_V_out_din");
    sc_trace(mVcdFile, img_5_rows_V_out_full_n, "(port)img_5_rows_V_out_full_n");
    sc_trace(mVcdFile, img_5_rows_V_out_write, "(port)img_5_rows_V_out_write");
    sc_trace(mVcdFile, img_5_cols_V_out_din, "(port)img_5_cols_V_out_din");
    sc_trace(mVcdFile, img_5_cols_V_out_full_n, "(port)img_5_cols_V_out_full_n");
    sc_trace(mVcdFile, img_5_cols_V_out_write, "(port)img_5_cols_V_out_write");
#endif
    ...
    sc_trace(mVcdFile, img_5_rows_V_out_blk_n, "img_5_rows_V_out_blk_n");
    sc_trace(mVcdFile, img_5_cols_V_out_blk_n, "img_5_cols_V_out_blk_n");
    ...
    if ( ap_rst.read() == ap_const_logic_1) {
        ...
        if (esl_seteq<1,1,1>(ap_const_logic_1, ap_continue.read())) {
            ap_done_reg = ap_const_logic_0;
                    ...
                    !(esl_seteq<1,1,1>(ap_const_logic_0, real_start.read()) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1) || esl_seteq<1,1,1>(ap_const_logic_0, img_0_rows_V_out_full_n.read()) || esl_seteq<1,1,1>(ap_const_logic_0, img_0_cols_V_out_full_n.read()) || esl_seteq<1,1,1>(ap_const_logic_0, img_5_rows_V_out_full_n.read()) || esl_seteq<1,1,1>(ap_const_logic_0, img_5_cols_V_out_full_n.read())))) {
...
void Block_proc::thread_img_5_cols_V_out_blk_n() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
         !(esl_seteq<1,1,1>(ap_const_logic_0, real_start.read()) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1)))) {
        img_5_cols_V_out_blk_n = img_5_cols_V_out_full_n.read();
    } else {
        img_5_cols_V_out_blk_n = ap_const_logic_1;
    }
}

void Block_proc::thread_img_5_cols_V_out_din() {
    img_5_cols_V_out_din = ap_const_lv12_500;
}

void Block_proc::thread_img_5_cols_V_out_write() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
         !(esl_seteq<1,1,1>(ap_const_logic_0, real_start.read()) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1) || esl_seteq<1,1,1>(ap_const_logic_0, img_0_rows_V_out_full_n.read()) || esl_seteq<1,1,1>(ap_const_logic_0, img_0_cols_V_out_full_n.read()) || esl_seteq<1,1,1>(ap_const_logic_0, img_5_rows_V_out_full_n.read()) || esl_seteq<1,1,1>(ap_const_logic_0, img_5_cols_V_out_full_n.read())))) {
...
void Block_proc::thread_img_5_rows_V_out_blk_n() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
         !(esl_seteq<1,1,1>(ap_const_logic_0, real_start.read()) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1)))) {
        img_5_rows_V_out_blk_n = img_5_rows_V_out_full_n.read();
    } else {
        img_5_rows_V_out_blk_n = ap_const_logic_1;
    }
}

void Block_proc::thread_img_5_rows_V_out_din() {
    img_5_rows_V_out_din = ap_const_lv11_2D0;
}

void Block_proc::thread_img_5_rows_V_out_write() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
         !(esl_seteq<1,1,1>(ap_const_logic_0, real_start.read()) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1) || esl_seteq<1,1,1>(ap_const_logic_0, img_0_rows_V_out_full_n.read()) || esl_seteq<1,1,1>(ap_const_logic_0, img_0_cols_V_out_full_n.read()) || esl_seteq<1,1,1>(ap_const_logic_0, img_5_rows_V_out_full_n.read()) || esl_seteq<1,1,1>(ap_const_logic_0, img_5_cols_V_out_full_n.read())))) {
