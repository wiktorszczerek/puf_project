...
struct AXIvideo2Mat : public sc_module {
    ...
    regslice_both<24>* regslice_both_AXI_video_strm_V_data_V_U;
    regslice_both<3>* regslice_both_AXI_video_strm_V_keep_V_U;
    regslice_both<3>* regslice_both_AXI_video_strm_V_strb_V_U;
    ...
    sc_signal< sc_lv<24> > axi_data_V_1_i_reg_289;
    sc_signal< sc_lv<32> > t_V_5_reg_300;
    sc_signal< sc_lv<1> > eol_0_i_reg_311;
    sc_signal< sc_lv<1> > axi_last_V_2_i_reg_323;
    sc_signal< sc_lv<24> > p_Val2_s_reg_336;
    ...
    sc_signal< sc_lv<24> > tmp_data_V_reg_479;
    ...
    sc_signal< sc_lv<8> > tmp_6_reg_526;
    sc_signal< sc_lv<8> > tmp_7_reg_531;
    ...
    sc_signal< sc_lv<24> > axi_data_V_3_i_reg_360;
    sc_signal< sc_lv<24> > axi_data_V_0_i_reg_257;
    sc_signal< sc_lv<32> > t_V_reg_267;
    sc_signal< sc_lv<1> > ap_phi_mux_eol_phi_fu_281_p4;
    sc_signal< sc_lv<24> > ap_phi_mux_axi_data_V_1_i_phi_fu_292_p4;
    sc_signal< sc_lv<1> > ap_phi_mux_eol_0_i_phi_fu_315_p4;
    sc_signal< sc_lv<1> > ap_phi_reg_pp1_iter0_axi_last_V_2_i_reg_323;
    sc_signal< sc_lv<24> > ap_phi_mux_p_Val2_s_phi_fu_340_p4;
    sc_signal< sc_lv<24> > ap_phi_reg_pp1_iter0_p_Val2_s_reg_336;
    ...
    sc_signal< sc_lv<24> > INPUT_STREAM_TDATA_int;
    ...
    sc_signal< sc_lv<3> > INPUT_STREAM_TKEEP_int;
    ...
    sc_signal< sc_lv<3> > INPUT_STREAM_TSTRB_int;
    ...
    sc_signal< sc_lv<1> > INPUT_STREAM_TUSER_int;
    ...
    sc_signal< sc_lv<1> > INPUT_STREAM_TID_int;
    ...
    sc_signal< sc_lv<1> > INPUT_STREAM_TDEST_int;
