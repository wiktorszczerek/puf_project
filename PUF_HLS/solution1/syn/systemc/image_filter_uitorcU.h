...
// ==============================================================
#ifndef __image_filter_uitorcU__HH__
#define __image_filter_uitorcU__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(image_filter_uitorcU) {
    ...
    SC_CTOR(image_filter_uitorcU):  ACMP_uitodp_U ("ACMP_uitodp_U") {
