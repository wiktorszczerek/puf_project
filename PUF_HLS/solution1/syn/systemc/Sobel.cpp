...
const sc_lv<3> Sobel::ap_const_lv3_6 = "110";
...
void Sobel::thread_ap_var_for_const2() {
    ap_var_for_const2 = ap_const_lv3_6;
}

void Sobel::thread_ap_var_for_const3() {
    ap_var_for_const3 = ap_const_lv4_2;
}

void Sobel::thread_ap_var_for_const4() {
    ap_var_for_const4 = ap_const_lv2_3;
}
    ...
    if ( ap_rst.read() == ap_const_logic_1) {
        ...
        if (esl_seteq<1,1,1>(ap_const_logic_1, ap_continue.read())) {
            ap_done_reg = ap_const_logic_0;
                    ...
                    esl_seteq<1,1,1>(grp_Filter2D_fu_52_ap_done.read(), ap_const_logic_1))) {
...
void Sobel::thread_p_dst_data_stream_V_write() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read())) {
...
void Sobel::thread_p_src_data_stream_V_read() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read())) {
...
void Sobel::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        case 1 : 
            ...
            break;
        case 2 : 
            if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && esl_seteq<1,1,1>(grp_Filter2D_fu_52_ap_done.read(), ap_const_logic_1))) {
                ap_NS_fsm = ap_ST_fsm_state1;
            } else {
                ap_NS_fsm = ap_ST_fsm_state2;
            }
