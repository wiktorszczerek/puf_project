...
// ==============================================================
#ifndef __Filter2D_1_k_buf_eOg_H__
#define __Filter2D_1_k_buf_eOg_H__
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(Filter2D_1_k_buf_eOg_ram) {
...
SC_MODULE(Filter2D_1_k_buf_eOg) {
...
Filter2D_1_k_buf_eOg_ram* meminst;


SC_CTOR(Filter2D_1_k_buf_eOg) {
meminst = new Filter2D_1_k_buf_eOg_ram("Filter2D_1_k_buf_eOg_ram");
