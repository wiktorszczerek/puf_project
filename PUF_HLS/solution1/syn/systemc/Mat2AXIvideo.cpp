...
Mat2AXIvideo::Mat2AXIvideo(sc_module_name name) : sc_module(name), mVcdFile(0) {
    regslice_both_AXI_video_strm_V_data_V_U = new regslice_both<24>("regslice_both_AXI_video_strm_V_data_V_U");
    regslice_both_AXI_video_strm_V_data_V_U->ap_clk(ap_clk);
    regslice_both_AXI_video_strm_V_data_V_U->ap_rst(ap_rst);
    regslice_both_AXI_video_strm_V_data_V_U->data_in(OUTPUT_STREAM_TDATA_int);
    regslice_both_AXI_video_strm_V_data_V_U->vld_in(OUTPUT_STREAM_TVALID_int);
    regslice_both_AXI_video_strm_V_data_V_U->ack_in(OUTPUT_STREAM_TREADY_int);
    regslice_both_AXI_video_strm_V_data_V_U->data_out(OUTPUT_STREAM_TDATA);
    regslice_both_AXI_video_strm_V_data_V_U->vld_out(regslice_both_AXI_video_strm_V_data_V_U_vld_out);
    regslice_both_AXI_video_strm_V_data_V_U->ack_out(OUTPUT_STREAM_TREADY);
    regslice_both_AXI_video_strm_V_data_V_U->apdone_blk(regslice_both_AXI_video_strm_V_data_V_U_apdone_blk);
    regslice_both_AXI_video_strm_V_keep_V_U = new regslice_both<3>("regslice_both_AXI_video_strm_V_keep_V_U");
    ...
    regslice_both_AXI_video_strm_V_keep_V_U->vld_in(OUTPUT_STREAM_TVALID_int);
    regslice_both_AXI_video_strm_V_keep_V_U->ack_in(regslice_both_AXI_video_strm_V_keep_V_U_ack_in_dummy);
    regslice_both_AXI_video_strm_V_keep_V_U->data_out(OUTPUT_STREAM_TKEEP);
    regslice_both_AXI_video_strm_V_keep_V_U->vld_out(regslice_both_AXI_video_strm_V_keep_V_U_vld_out);
    regslice_both_AXI_video_strm_V_keep_V_U->ack_out(OUTPUT_STREAM_TREADY);
    regslice_both_AXI_video_strm_V_keep_V_U->apdone_blk(regslice_both_AXI_video_strm_V_keep_V_U_apdone_blk);
    regslice_both_AXI_video_strm_V_strb_V_U = new regslice_both<3>("regslice_both_AXI_video_strm_V_strb_V_U");
    ...
    regslice_both_AXI_video_strm_V_strb_V_U->vld_in(OUTPUT_STREAM_TVALID_int);
    regslice_both_AXI_video_strm_V_strb_V_U->ack_in(regslice_both_AXI_video_strm_V_strb_V_U_ack_in_dummy);
    regslice_both_AXI_video_strm_V_strb_V_U->data_out(OUTPUT_STREAM_TSTRB);
    regslice_both_AXI_video_strm_V_strb_V_U->vld_out(regslice_both_AXI_video_strm_V_strb_V_U_vld_out);
    regslice_both_AXI_video_strm_V_strb_V_U->ack_out(OUTPUT_STREAM_TREADY);
    ...
    regslice_both_AXI_video_strm_V_user_V_U->data_in(tmp_user_V_fu_126);
    regslice_both_AXI_video_strm_V_user_V_U->vld_in(OUTPUT_STREAM_TVALID_int);
    regslice_both_AXI_video_strm_V_user_V_U->ack_in(regslice_both_AXI_video_strm_V_user_V_U_ack_in_dummy);
    regslice_both_AXI_video_strm_V_user_V_U->data_out(OUTPUT_STREAM_TUSER);
    regslice_both_AXI_video_strm_V_user_V_U->vld_out(regslice_both_AXI_video_strm_V_user_V_U_vld_out);
    regslice_both_AXI_video_strm_V_user_V_U->ack_out(OUTPUT_STREAM_TREADY);
    ...
    regslice_both_AXI_video_strm_V_last_V_U->data_in(axi_last_V_reg_279);
    regslice_both_AXI_video_strm_V_last_V_U->vld_in(OUTPUT_STREAM_TVALID_int);
    regslice_both_AXI_video_strm_V_last_V_U->ack_in(regslice_both_AXI_video_strm_V_last_V_U_ack_in_dummy);
    regslice_both_AXI_video_strm_V_last_V_U->data_out(OUTPUT_STREAM_TLAST);
    regslice_both_AXI_video_strm_V_last_V_U->vld_out(regslice_both_AXI_video_strm_V_last_V_U_vld_out);
    regslice_both_AXI_video_strm_V_last_V_U->ack_out(OUTPUT_STREAM_TREADY);
    ...
    regslice_both_AXI_video_strm_V_id_V_U->vld_in(OUTPUT_STREAM_TVALID_int);
    regslice_both_AXI_video_strm_V_id_V_U->ack_in(regslice_both_AXI_video_strm_V_id_V_U_ack_in_dummy);
    regslice_both_AXI_video_strm_V_id_V_U->data_out(OUTPUT_STREAM_TID);
    regslice_both_AXI_video_strm_V_id_V_U->vld_out(regslice_both_AXI_video_strm_V_id_V_U_vld_out);
    regslice_both_AXI_video_strm_V_id_V_U->ack_out(OUTPUT_STREAM_TREADY);
    ...
    regslice_both_AXI_video_strm_V_dest_V_U->vld_in(OUTPUT_STREAM_TVALID_int);
    regslice_both_AXI_video_strm_V_dest_V_U->ack_in(regslice_both_AXI_video_strm_V_dest_V_U_ack_in_dummy);
    regslice_both_AXI_video_strm_V_dest_V_U->data_out(OUTPUT_STREAM_TDEST);
    regslice_both_AXI_video_strm_V_dest_V_U->vld_out(regslice_both_AXI_video_strm_V_dest_V_U_vld_out);
    regslice_both_AXI_video_strm_V_dest_V_U->ack_out(OUTPUT_STREAM_TREADY);
    ...
    sensitive << ( icmp_ln126_reg_270 );
    sensitive << ( ap_enable_reg_pp0_iter2 );
    sensitive << ( icmp_ln126_reg_270_pp0_iter1_reg );
    ...
    sensitive << ( icmp_ln126_fu_216_p2 );

    SC_METHOD(thread_ap_done);
    sensitive << ( ap_done_reg );
    sensitive << ( icmp_ln125_fu_204_p2 );
    ...
    SC_METHOD(thread_icmp_ln125_fu_204_p2);
    sensitive << ( ap_CS_fsm_state2 );
    sensitive << ( regslice_both_AXI_video_strm_V_data_V_U_apdone_blk );
    sensitive << ( t_V_reg_177 );

    SC_METHOD(thread_icmp_ln126_fu_216_p2);
    sensitive << ( ap_CS_fsm_pp0_stage0 );
    sensitive << ( t_V_1_reg_188 );
    sensitive << ( ap_block_pp0_stage0_11001 );
    sensitive << ( ap_enable_reg_pp0_iter0 );
    ...
    sc_trace(mVcdFile, icmp_ln126_reg_270, "icmp_ln126_reg_270");
    ...
    sc_trace(mVcdFile, icmp_ln126_reg_270_pp0_iter1_reg, "icmp_ln126_reg_270_pp0_iter1_reg");
    sc_trace(mVcdFile, t_V_1_reg_188, "t_V_1_reg_188");
    sc_trace(mVcdFile, icmp_ln125_fu_204_p2, "icmp_ln125_fu_204_p2");
    ...
    sc_trace(mVcdFile, icmp_ln126_fu_216_p2, "icmp_ln126_fu_216_p2");
...
void Mat2AXIvideo::thread_ap_clk_no_reset_() {
    ...
    if ( ap_rst.read() == ap_const_logic_1) {
        ...
        if (esl_seteq<1,1,1>(ap_const_logic_1, ap_continue.read())) {
            ap_done_reg = ap_const_logic_0;
                    ...
                    esl_seteq<1,1,1>(icmp_ln125_fu_204_p2.read(), ap_const_lv1_1))) {
    ...
    if ( ap_rst.read() == ap_const_logic_1) {
        ...
        if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && 
            ...
            ap_enable_reg_pp0_iter0 = ap_const_logic_0;
                    ...
                    esl_seteq<1,1,1>(regslice_both_AXI_video_strm_V_data_V_U_apdone_blk.read(), ap_const_logic_0) && 
                    esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln125_fu_204_p2.read()))) {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && 
         ...
         esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln126_fu_216_p2.read()))) {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && 
         ...
         esl_seteq<1,1,1>(icmp_ln126_reg_270.read(), ap_const_lv1_0) && 
         esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0))) {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln126_fu_216_p2.read()))) {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0))) {
        icmp_ln126_reg_270 = icmp_ln126_fu_216_p2.read();
        icmp_ln126_reg_270_pp0_iter1_reg = icmp_ln126_reg_270.read();
    }
}
...
void Mat2AXIvideo::thread_OUTPUT_STREAM_TDATA_blk_n() {
    if (((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && 
         ...
         (esl_seteq<1,1,1>(ap_block_pp0_stage0.read(), ap_const_boolean_0) && 
          ...
          esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln126_reg_270_pp0_iter1_reg.read())))) {
...
void Mat2AXIvideo::thread_OUTPUT_STREAM_TDATA_int() {
    OUTPUT_STREAM_TDATA_int = esl_concat<16,8>(esl_concat<8,8>(img_data_stream_2_V_dout.read(), img_data_stream_1_V_dout.read()), img_data_stream_0_V_dout.read());
}

void Mat2AXIvideo::thread_OUTPUT_STREAM_TVALID() {
    OUTPUT_STREAM_TVALID = regslice_both_AXI_video_strm_V_data_V_U_vld_out.read();
}

void Mat2AXIvideo::thread_OUTPUT_STREAM_TVALID_int() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && 
         esl_seteq<1,1,1>(icmp_ln126_reg_270.read(), ap_const_lv1_0) && 
         esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0))) {
...
void Mat2AXIvideo::thread_ap_block_pp0_stage0_01001() {
    ap_block_pp0_stage0_01001 = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && ((esl_seteq<1,1,1>(icmp_ln126_reg_270.read(), ap_const_lv1_0) && 
...
void Mat2AXIvideo::thread_ap_block_state4_io() {
    ap_block_state4_io = (esl_seteq<1,1,1>(icmp_ln126_reg_270.read(), ap_const_lv1_0) && esl_seteq<1,1,1>(ap_const_logic_0, OUTPUT_STREAM_TREADY_int.read()));
}

void Mat2AXIvideo::thread_ap_block_state4_pp0_stage0_iter1() {
    ap_block_state4_pp0_stage0_iter1 = ((esl_seteq<1,1,1>(icmp_ln126_reg_270.read(), ap_const_lv1_0) && 
  esl_seteq<1,1,1>(ap_const_logic_0, img_data_stream_0_V_empty_n.read())) || (esl_seteq<1,1,1>(icmp_ln126_reg_270.read(), ap_const_lv1_0) && 
  esl_seteq<1,1,1>(ap_const_logic_0, img_data_stream_1_V_empty_n.read())) || (esl_seteq<1,1,1>(icmp_ln126_reg_270.read(), ap_const_lv1_0) && 
  esl_seteq<1,1,1>(ap_const_logic_0, img_data_stream_2_V_empty_n.read())));
}

void Mat2AXIvideo::thread_ap_block_state5_io() {
    ap_block_state5_io = (esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln126_reg_270_pp0_iter1_reg.read()) && esl_seteq<1,1,1>(ap_const_logic_0, OUTPUT_STREAM_TREADY_int.read()));
}
...
void Mat2AXIvideo::thread_ap_condition_pp0_exit_iter0_state3() {
    if (esl_seteq<1,1,1>(icmp_ln126_fu_216_p2.read(), ap_const_lv1_1)) {
...
void Mat2AXIvideo::thread_icmp_ln125_fu_204_p2() {
    icmp_ln125_fu_204_p2 = (!t_V_reg_177.read().is_01() || !ap_const_lv10_2D0.is_01())? sc_lv<1>(): sc_lv<1>(t_V_reg_177.read() == ap_const_lv10_2D0);
}

void Mat2AXIvideo::thread_icmp_ln126_fu_216_p2() {
    icmp_ln126_fu_216_p2 = (!t_V_1_reg_188.read().is_01() || !ap_const_lv11_500.is_01())? sc_lv<1>(): sc_lv<1>(t_V_1_reg_188.read() == ap_const_lv11_500);
}
...
void Mat2AXIvideo::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        case 1 : 
            ...
            break;
        case 2 : 
            if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && esl_seteq<1,1,1>(regslice_both_AXI_video_strm_V_data_V_U_apdone_blk.read(), ap_const_logic_0) && esl_seteq<1,1,1>(icmp_ln125_fu_204_p2.read(), ap_const_lv1_1))) {
                ap_NS_fsm = ap_ST_fsm_state1;
            } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && esl_seteq<1,1,1>(regslice_both_AXI_video_strm_V_data_V_U_apdone_blk.read(), ap_const_logic_0) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln125_fu_204_p2.read()))) {
            ...
            break;
        case 4 : 
            if ((!(esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter2.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_subdone.read(), ap_const_boolean_0) && esl_seteq<1,1,1>(ap_enable_reg_pp0_iter1.read(), ap_const_logic_0)) && !(esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_subdone.read(), ap_const_boolean_0) && esl_seteq<1,1,1>(icmp_ln126_fu_216_p2.read(), ap_const_lv1_1) && esl_seteq<1,1,1>(ap_enable_reg_pp0_iter1.read(), ap_const_logic_0)))) {
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            } else if (((esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter2.read()) && 
  esl_seteq<1,1,1>(ap_block_pp0_stage0_subdone.read(), ap_const_boolean_0) && 
  esl_seteq<1,1,1>(ap_enable_reg_pp0_iter1.read(), ap_const_logic_0)) || (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()) && 
  esl_seteq<1,1,1>(ap_block_pp0_stage0_subdone.read(), ap_const_boolean_0) && 
  esl_seteq<1,1,1>(icmp_ln126_fu_216_p2.read(), ap_const_lv1_1) && 
