...
CvtColor::CvtColor(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sensitive << ( icmp_ln1968_fu_223_p2 );

    SC_METHOD(thread_ap_done);
    sensitive << ( ap_done_reg );
    sensitive << ( icmp_ln1967_fu_208_p2 );
    ...
    sensitive << ( i_0_i_reg_182 );

    SC_METHOD(thread_icmp_ln1967_fu_208_p2);
    sensitive << ( p_src_rows_V_read_reg_239 );
    sensitive << ( ap_CS_fsm_state2 );
    sensitive << ( zext_ln1967_fu_204_p1 );

    SC_METHOD(thread_icmp_ln1968_fu_223_p2);
    sensitive << ( ap_CS_fsm_pp0_stage0 );
    sensitive << ( p_src_cols_V_read_reg_234 );
    sensitive << ( ap_block_pp0_stage0_11001 );
    sensitive << ( ap_enable_reg_pp0_iter0 );
    sensitive << ( zext_ln1968_fu_219_p1 );
    ...
    SC_METHOD(thread_zext_ln1967_fu_204_p1);
    sensitive << ( i_0_i_reg_182 );

    SC_METHOD(thread_zext_ln1968_fu_219_p1);
    sensitive << ( j_0_i_reg_193 );
    ...
    sc_trace(mVcdFile, icmp_ln1968_reg_253, "icmp_ln1968_reg_253");
    ...
    sc_trace(mVcdFile, j_0_i_reg_193, "j_0_i_reg_193");
    sc_trace(mVcdFile, p_src_cols_V_read_reg_234, "p_src_cols_V_read_reg_234");
    sc_trace(mVcdFile, ap_block_state1, "ap_block_state1");
    sc_trace(mVcdFile, p_src_rows_V_read_reg_239, "p_src_rows_V_read_reg_239");
    sc_trace(mVcdFile, icmp_ln1967_fu_208_p2, "icmp_ln1967_fu_208_p2");
    sc_trace(mVcdFile, ap_CS_fsm_state2, "ap_CS_fsm_state2");
    sc_trace(mVcdFile, i_fu_213_p2, "i_fu_213_p2");
    sc_trace(mVcdFile, i_reg_248, "i_reg_248");
    sc_trace(mVcdFile, icmp_ln1968_fu_223_p2, "icmp_ln1968_fu_223_p2");
    ...
    sc_trace(mVcdFile, i_0_i_reg_182, "i_0_i_reg_182");
    sc_trace(mVcdFile, ap_CS_fsm_state5, "ap_CS_fsm_state5");
    sc_trace(mVcdFile, ap_block_pp0_stage0_01001, "ap_block_pp0_stage0_01001");
    sc_trace(mVcdFile, zext_ln1967_fu_204_p1, "zext_ln1967_fu_204_p1");
    sc_trace(mVcdFile, zext_ln1968_fu_219_p1, "zext_ln1968_fu_219_p1");
...
void CvtColor::thread_ap_clk_no_reset_() {
    ...
    if ( ap_rst.read() == ap_const_logic_1) {
        ...
        if (esl_seteq<1,1,1>(ap_const_logic_1, ap_continue.read())) {
            ap_done_reg = ap_const_logic_0;
                    ...
                    esl_seteq<1,1,1>(icmp_ln1967_fu_208_p2.read(), ap_const_lv1_0))) {
    ...
    if ( ap_rst.read() == ap_const_logic_1) {
        ...
        if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && 
            ...
            ap_enable_reg_pp0_iter0 = ap_const_logic_0;
                    ...
                    esl_seteq<1,1,1>(ap_const_lv1_1, icmp_ln1967_fu_208_p2.read()))) {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && 
         ...
         esl_seteq<1,1,1>(ap_const_lv1_1, icmp_ln1968_fu_223_p2.read()))) {
        j_0_i_reg_193 = j_fu_228_p2.read();
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && 
                esl_seteq<1,1,1>(ap_const_lv1_1, icmp_ln1967_fu_208_p2.read()))) {
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read())) {
        i_reg_248 = i_fu_213_p2.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0))) {
        icmp_ln1968_reg_253 = icmp_ln1968_fu_223_p2.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && !(esl_seteq<1,1,1>(ap_const_logic_0, real_start.read()) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1) || esl_seteq<1,1,1>(ap_const_logic_0, p_src_cols_V_empty_n.read()) || esl_seteq<1,1,1>(ap_const_logic_0, p_src_rows_V_empty_n.read())))) {
        p_src_cols_V_read_reg_234 = p_src_cols_V_dout.read();
        p_src_rows_V_read_reg_239 = p_src_rows_V_dout.read();
    }
}
...
void CvtColor::thread_ap_block_pp0_stage0_01001() {
    ap_block_pp0_stage0_01001 = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && ((esl_seteq<1,1,1>(icmp_ln1968_reg_253.read(), ap_const_lv1_1) && 
   esl_seteq<1,1,1>(ap_const_logic_0, p_src_data_stream_V_empty_n.read())) || 
  (esl_seteq<1,1,1>(icmp_ln1968_reg_253.read(), ap_const_lv1_1) && 
...
void CvtColor::thread_ap_block_pp0_stage0_11001() {
    ap_block_pp0_stage0_11001 = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && ((esl_seteq<1,1,1>(icmp_ln1968_reg_253.read(), ap_const_lv1_1) && 
   esl_seteq<1,1,1>(ap_const_logic_0, p_src_data_stream_V_empty_n.read())) || 
  (esl_seteq<1,1,1>(icmp_ln1968_reg_253.read(), ap_const_lv1_1) && 
   esl_seteq<1,1,1>(ap_const_logic_0, p_dst_data_stream_0_V_full_n.read())) || 
  (esl_seteq<1,1,1>(icmp_ln1968_reg_253.read(), ap_const_lv1_1) && 
...
void CvtColor::thread_ap_block_pp0_stage0_subdone() {
    ap_block_pp0_stage0_subdone = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && ((esl_seteq<1,1,1>(icmp_ln1968_reg_253.read(), ap_const_lv1_1) && 
   esl_seteq<1,1,1>(ap_const_logic_0, p_src_data_stream_V_empty_n.read())) || 
  (esl_seteq<1,1,1>(icmp_ln1968_reg_253.read(), ap_const_lv1_1) && 
   esl_seteq<1,1,1>(ap_const_logic_0, p_dst_data_stream_0_V_full_n.read())) || 
  (esl_seteq<1,1,1>(icmp_ln1968_reg_253.read(), ap_const_lv1_1) && 
...
void CvtColor::thread_ap_block_state4_pp0_stage0_iter1() {
    ap_block_state4_pp0_stage0_iter1 = ((esl_seteq<1,1,1>(icmp_ln1968_reg_253.read(), ap_const_lv1_1) && 
  esl_seteq<1,1,1>(ap_const_logic_0, p_src_data_stream_V_empty_n.read())) || (esl_seteq<1,1,1>(icmp_ln1968_reg_253.read(), ap_const_lv1_1) && 
  esl_seteq<1,1,1>(ap_const_logic_0, p_dst_data_stream_0_V_full_n.read())) || (esl_seteq<1,1,1>(icmp_ln1968_reg_253.read(), ap_const_lv1_1) && 
  esl_seteq<1,1,1>(ap_const_logic_0, p_dst_data_stream_1_V_full_n.read())) || (esl_seteq<1,1,1>(icmp_ln1968_reg_253.read(), ap_const_lv1_1) && 
  esl_seteq<1,1,1>(ap_const_logic_0, p_dst_data_stream_2_V_full_n.read())));
}

void CvtColor::thread_ap_condition_pp0_exit_iter0_state3() {
    if (esl_seteq<1,1,1>(icmp_ln1968_fu_223_p2.read(), ap_const_lv1_0)) {
...
void CvtColor::thread_i_fu_213_p2() {
    i_fu_213_p2 = (!i_0_i_reg_182.read().is_01() || !ap_const_lv10_1.is_01())? sc_lv<10>(): (sc_biguint<10>(i_0_i_reg_182.read()) + sc_biguint<10>(ap_const_lv10_1));
}

void CvtColor::thread_icmp_ln1967_fu_208_p2() {
    icmp_ln1967_fu_208_p2 = (!zext_ln1967_fu_204_p1.read().is_01() || !p_src_rows_V_read_reg_239.read().is_01())? sc_lv<1>(): (sc_bigint<11>(zext_ln1967_fu_204_p1.read()) < sc_bigint<11>(p_src_rows_V_read_reg_239.read()));
}

void CvtColor::thread_icmp_ln1968_fu_223_p2() {
    icmp_ln1968_fu_223_p2 = (!zext_ln1968_fu_219_p1.read().is_01() || !p_src_cols_V_read_reg_234.read().is_01())? sc_lv<1>(): (sc_bigint<12>(zext_ln1968_fu_219_p1.read()) < sc_bigint<12>(p_src_cols_V_read_reg_234.read()));
}
...
void CvtColor::thread_j_fu_228_p2() {
    j_fu_228_p2 = (!j_0_i_reg_193.read().is_01() || !ap_const_lv11_1.is_01())? sc_lv<11>(): (sc_biguint<11>(j_0_i_reg_193.read()) + sc_biguint<11>(ap_const_lv11_1));
}
...
void CvtColor::thread_zext_ln1967_fu_204_p1() {
    zext_ln1967_fu_204_p1 = esl_zext<11,10>(i_0_i_reg_182.read());
}

void CvtColor::thread_zext_ln1968_fu_219_p1() {
    zext_ln1968_fu_219_p1 = esl_zext<12,11>(j_0_i_reg_193.read());
}
...
void CvtColor::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        case 1 : 
            ...
            break;
        case 2 : 
            if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && esl_seteq<1,1,1>(icmp_ln1967_fu_208_p2.read(), ap_const_lv1_0))) {
                ap_NS_fsm = ap_ST_fsm_state1;
            } else {
            ...
            break;
        case 4 : 
            if (!(esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_subdone.read(), ap_const_boolean_0) && esl_seteq<1,1,1>(icmp_ln1968_fu_223_p2.read(), ap_const_lv1_0))) {
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_subdone.read(), ap_const_boolean_0) && esl_seteq<1,1,1>(icmp_ln1968_fu_223_p2.read(), ap_const_lv1_0))) {
