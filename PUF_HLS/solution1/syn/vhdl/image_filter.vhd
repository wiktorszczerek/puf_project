...
architecture behav of image_filter is 
    ...
    "image_filter,hls_ip_2019_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7a200t-sbg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=11.000000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=9,HLS_SYN_DSP=35,HLS_SYN_FF=6013,HLS_SYN_LUT=10095,HLS_VERSION=2019_2}";
    ...
    signal Block_proc_U0_img_5_rows_V_out_din : STD_LOGIC_VECTOR (10 downto 0);
    signal Block_proc_U0_img_5_rows_V_out_write : STD_LOGIC;
    signal Block_proc_U0_img_5_cols_V_out_din : STD_LOGIC_VECTOR (11 downto 0);
    ...
    signal AddWeighted_U0_dst_rows_V_out_din : STD_LOGIC_VECTOR (10 downto 0);
    ...
    signal img_5_rows_V_c_dout : STD_LOGIC_VECTOR (10 downto 0);
    signal img_5_rows_V_c_empty_n : STD_LOGIC;
    signal img_5_cols_V_c_full_n : STD_LOGIC;
    signal img_5_cols_V_c_dout : STD_LOGIC_VECTOR (11 downto 0);
    ...
    signal img_0_rows_V_c22_dout : STD_LOGIC_VECTOR (10 downto 0);
    signal img_0_rows_V_c22_empty_n : STD_LOGIC;
    signal img_0_cols_V_c23_full_n : STD_LOGIC;
    signal img_0_cols_V_c23_dout : STD_LOGIC_VECTOR (11 downto 0);
    ...
    signal img_5_rows_V_c24_dout : STD_LOGIC_VECTOR (10 downto 0);
    signal img_5_rows_V_c24_empty_n : STD_LOGIC;
    signal img_5_cols_V_c25_full_n : STD_LOGIC;
    signal img_5_cols_V_c25_dout : STD_LOGIC_VECTOR (11 downto 0);
    ...
    port (
        ...
        img_5_rows_V_out_din : OUT STD_LOGIC_VECTOR (10 downto 0);
        img_5_rows_V_out_full_n : IN STD_LOGIC;
        img_5_rows_V_out_write : OUT STD_LOGIC;
        img_5_cols_V_out_din : OUT STD_LOGIC_VECTOR (11 downto 0);
        img_5_cols_V_out_full_n : IN STD_LOGIC;
        img_5_cols_V_out_write : OUT STD_LOGIC );
    end component;
    ...
    component start_for_AddWeigsc4 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component start_for_Gaussiaudo IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component start_for_Duplicavdy IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component start_for_Sobel_1wdI IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    ...
    port map (
        ...
        img_5_rows_V_out_din => Block_proc_U0_img_5_rows_V_out_din,
        img_5_rows_V_out_full_n => img_5_rows_V_c_full_n,
        img_5_rows_V_out_write => Block_proc_U0_img_5_rows_V_out_write,
        img_5_cols_V_out_din => Block_proc_U0_img_5_cols_V_out_din,
        img_5_cols_V_out_full_n => img_5_cols_V_c_full_n,
        img_5_cols_V_out_write => Block_proc_U0_img_5_cols_V_out_write);
    ...
    port map (
        ...
        dst_rows_V_dout => img_5_rows_V_c_dout,
        dst_rows_V_empty_n => img_5_rows_V_c_empty_n,
        dst_rows_V_read => AddWeighted_U0_dst_rows_V_read,
        dst_cols_V_dout => img_5_cols_V_c_dout,
        dst_cols_V_empty_n => img_5_cols_V_c_empty_n,
    ...
    port map (
        ...
        p_src_rows_V_dout => img_5_rows_V_c24_dout,
        p_src_rows_V_empty_n => img_5_rows_V_c24_empty_n,
        p_src_rows_V_read => CvtColor_U0_p_src_rows_V_read,
        p_src_cols_V_dout => img_5_cols_V_c25_dout,
        p_src_cols_V_empty_n => img_5_cols_V_c25_empty_n,
    ...
    img_5_rows_V_c_U : component fifo_w11_d7_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => Block_proc_U0_img_5_rows_V_out_din,
        if_full_n => img_5_rows_V_c_full_n,
        if_write => Block_proc_U0_img_5_rows_V_out_write,
        if_dout => img_5_rows_V_c_dout,
        if_empty_n => img_5_rows_V_c_empty_n,
        if_read => AddWeighted_U0_dst_rows_V_read);

    img_5_cols_V_c_U : component fifo_w12_d7_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => Block_proc_U0_img_5_cols_V_out_din,
        if_full_n => img_5_cols_V_c_full_n,
        if_write => Block_proc_U0_img_5_cols_V_out_write,
        if_dout => img_5_cols_V_c_dout,
        if_empty_n => img_5_cols_V_c_empty_n,
    ...
    img_0_rows_V_c22_U : component fifo_w11_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    img_0_cols_V_c23_U : component fifo_w12_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    img_5_rows_V_c24_U : component fifo_w11_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        ...
        if_full_n => img_5_rows_V_c24_full_n,
        if_write => AddWeighted_U0_dst_rows_V_out_write,
        if_dout => img_5_rows_V_c24_dout,
        if_empty_n => img_5_rows_V_c24_empty_n,
        if_read => CvtColor_U0_p_src_rows_V_read);

    img_5_cols_V_c25_U : component fifo_w12_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        ...
        if_full_n => img_5_cols_V_c25_full_n,
        if_write => AddWeighted_U0_dst_cols_V_out_write,
        if_dout => img_5_cols_V_c25_dout,
        if_empty_n => img_5_cols_V_c25_empty_n,
        if_read => CvtColor_U0_p_src_cols_V_read);

    img_6_data_stream_0_U : component fifo_w8_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    img_6_data_stream_1_U : component fifo_w8_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    img_6_data_stream_2_U : component fifo_w8_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_AddWeigsc4_U : component start_for_AddWeigsc4
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_Gaussiaudo_U : component start_for_Gaussiaudo
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_Duplicavdy_U : component start_for_Duplicavdy
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_Sobel_1wdI_U : component start_for_Sobel_1wdI
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
