...
wire    grp_Filter2D_1_fu_40_ap_ready;
wire    grp_Filter2D_1_fu_40_p_src_data_stream_V_read;
wire   [7:0] grp_Filter2D_1_fu_40_p_dst_data_stream_V_din;
wire    grp_Filter2D_1_fu_40_p_dst_data_stream_V_write;
reg    grp_Filter2D_1_fu_40_ap_start_reg;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((grp_Filter2D_1_fu_40_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state2))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
