...
architecture behav of GaussianBlur is 
    ...
    signal grp_Filter2D_1_fu_18_ap_start : STD_LOGIC;
    signal grp_Filter2D_1_fu_18_ap_done : STD_LOGIC;
    signal grp_Filter2D_1_fu_18_ap_idle : STD_LOGIC;
    signal grp_Filter2D_1_fu_18_ap_ready : STD_LOGIC;
    signal grp_Filter2D_1_fu_18_p_src_data_stream_V_read : STD_LOGIC;
    signal grp_Filter2D_1_fu_18_p_dst_data_stream_V_din : STD_LOGIC_VECTOR (7 downto 0);
    signal grp_Filter2D_1_fu_18_p_dst_data_stream_V_write : STD_LOGIC;
    signal ap_reg_grp_Filter2D_1_fu_18_ap_start : STD_LOGIC := '0';
...
begin
    grp_Filter2D_1_fu_18 : component Filter2D_1
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_const_logic_1 = ap_continue)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif (((ap_const_lv1_1 = ap_CS_fsm_state2) and not((ap_const_logic_0 = grp_Filter2D_1_fu_18_ap_done)))) then 
    ...
    ap_reg_grp_Filter2D_1_fu_18_ap_start_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ap_reg_grp_Filter2D_1_fu_18_ap_start <= ap_const_logic_0;
            else
                if (((ap_CS_fsm_state1 = ap_const_lv1_1) and not(((real_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))))) then 
                    ap_reg_grp_Filter2D_1_fu_18_ap_start <= ap_const_logic_1;
                elsif ((ap_const_logic_1 = grp_Filter2D_1_fu_18_ap_ready)) then 
                    ap_reg_grp_Filter2D_1_fu_18_ap_start <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    ap_NS_fsm_assign_proc : process (real_start, ap_done_reg, ap_CS_fsm, grp_Filter2D_1_fu_18_ap_done)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                if (not((ap_const_logic_0 = grp_Filter2D_1_fu_18_ap_done))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
                    ap_NS_fsm <= ap_ST_fsm_state2;
                end if;
    ...
    ap_done_assign_proc : process(ap_done_reg, grp_Filter2D_1_fu_18_ap_done, ap_CS_fsm_state2)
    begin
        if (((ap_const_logic_1 = ap_done_reg) or ((ap_const_lv1_1 = ap_CS_fsm_state2) and not((ap_const_logic_0 = grp_Filter2D_1_fu_18_ap_done))))) then 
    ...
    grp_Filter2D_1_fu_18_ap_start <= ap_reg_grp_Filter2D_1_fu_18_ap_start;

    internal_ap_ready_assign_proc : process(grp_Filter2D_1_fu_18_ap_done, ap_CS_fsm_state2)
    begin
        if (((ap_const_lv1_1 = ap_CS_fsm_state2) and not((ap_const_logic_0 = grp_Filter2D_1_fu_18_ap_done)))) then 
    ...
    p_dst_data_stream_V_write_assign_proc : process(grp_Filter2D_1_fu_18_p_dst_data_stream_V_write, ap_CS_fsm_state2)
    begin
    ...
    p_src_data_stream_V_read_assign_proc : process(grp_Filter2D_1_fu_18_p_src_data_stream_V_read, ap_CS_fsm_state2)
    begin
        if (((ap_const_lv1_1 = ap_CS_fsm_state2))) then 
            p_src_data_stream_V_read <= grp_Filter2D_1_fu_18_p_src_data_stream_V_read;
        else 
