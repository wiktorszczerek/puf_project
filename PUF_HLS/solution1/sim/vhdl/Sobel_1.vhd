...
begin
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, grp_Filter2D_fu_30_ap_done)
    begin
        case ap_CS_fsm is
    ...
    ap_ready_assign_proc : process(grp_Filter2D_fu_30_ap_done, ap_CS_fsm_state2)
    begin
