...
set C_modelArgList {
	...
	{ img_5_rows_V_out int 11 regular {fifo 1}  }
	{ img_5_cols_V_out int 12 regular {fifo 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "img_0_rows_V_out", "interface" : "fifo", "bitwidth" : 11, "direction" : "WRITEONLY"} , 
 	...
 	{ "Name" : "img_5_rows_V_out", "interface" : "fifo", "bitwidth" : 11, "direction" : "WRITEONLY"} , 
 	{ "Name" : "img_5_cols_V_out", "interface" : "fifo", "bitwidth" : 12, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ img_5_rows_V_out_din sc_out sc_lv 11 signal 2 } 
	{ img_5_rows_V_out_full_n sc_in sc_logic 1 signal 2 } 
	{ img_5_rows_V_out_write sc_out sc_logic 1 signal 2 } 
	{ img_5_cols_V_out_din sc_out sc_lv 12 signal 3 } 
	{ img_5_cols_V_out_full_n sc_in sc_logic 1 signal 3 } 
	{ img_5_cols_V_out_write sc_out sc_logic 1 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "img_5_rows_V_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "img_5_rows_V_out", "role": "din" }} , 
 	{ "name": "img_5_rows_V_out_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "img_5_rows_V_out", "role": "full_n" }} , 
 	{ "name": "img_5_rows_V_out_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "img_5_rows_V_out", "role": "write" }} , 
 	{ "name": "img_5_cols_V_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "img_5_cols_V_out", "role": "din" }} , 
 	{ "name": "img_5_cols_V_out_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "img_5_cols_V_out", "role": "full_n" }} , 
 	{ "name": "img_5_cols_V_out_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "img_5_cols_V_out", "role": "write" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "img_5_rows_V_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
					{"Name" : "img_5_rows_V_out_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "img_5_cols_V_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	...
	img_5_rows_V_out { ap_fifo {  { img_5_rows_V_out_din fifo_data 1 11 }  { img_5_rows_V_out_full_n fifo_status 0 1 }  { img_5_rows_V_out_write fifo_update 1 1 } } }
	img_5_cols_V_out { ap_fifo {  { img_5_cols_V_out_din fifo_data 1 12 }  { img_5_cols_V_out_full_n fifo_status 0 1 }  { img_5_cols_V_out_write fifo_update 1 1 } } }
}
