...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { p_kernel_val_0_V_1_read { I 2 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { p_kernel_val_0_V_2_read { I 2 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { p_kernel_val_1_V_2_read { I 4 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { p_kernel_val_2_V_0_read { I 2 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { p_kernel_val_2_V_1_read { I 3 vector } } \
} "
}
