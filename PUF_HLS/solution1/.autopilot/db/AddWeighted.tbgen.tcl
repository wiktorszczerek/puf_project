...
set C_modelArgMapList {[ 
	{ "Name" : "src1_data_stream_V", "interface" : "fifo", "bitwidth" : 8, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "dst_rows_V", "interface" : "fifo", "bitwidth" : 11, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "dst_rows_V_out", "interface" : "fifo", "bitwidth" : 11, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ dst_rows_V_dout sc_in sc_lv 11 signal 2 } 
	...
	{ dst_rows_V_out_din sc_out sc_lv 11 signal 5 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "dst_rows_V_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "dst_rows_V", "role": "dout" }} , 
 	...
 	{ "name": "dst_rows_V_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "dst_rows_V_out", "role": "din" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.image_filter_daddpcA_U73", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.image_filter_daddpcA_U74", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.image_filter_dmulqcK_U75", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.image_filter_dmulqcK_U76", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.image_filter_uitorcU_U77", "Parent" : "0"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.image_filter_uitorcU_U78", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1", "Max" : "943921"}
	, {"Name" : "Interval", "Min" : "1", "Max" : "943921"}
]}
...
set Spec2ImplPortList { 
	...
	dst_rows_V { ap_fifo {  { dst_rows_V_dout fifo_data 0 11 }  { dst_rows_V_empty_n fifo_status 0 1 }  { dst_rows_V_read fifo_update 1 1 } } }
	...
	dst_rows_V_out { ap_fifo {  { dst_rows_V_out_din fifo_data 1 11 }  { dst_rows_V_out_full_n fifo_status 0 1 }  { dst_rows_V_out_write fifo_update 1 1 } } }
